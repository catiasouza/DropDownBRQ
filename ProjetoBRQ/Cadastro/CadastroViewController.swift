...
class CadastroViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(scroll(notification: )), name: UIResponder.keyboardWillShowNotification ,object: nil)
                ...
                button.setTitle("Selecione o banco: ", for: .normal)
                button.translatesAutoresizingMaskIntoConstraints = false
            
                
                self.dropView.addSubview(button)
                button.topAnchor.constraint(equalTo: self.dropView.topAnchor).isActive = true
                button.widthAnchor.constraint(equalToConstant: 250).isActive = true
                button.centerXAnchor.constraint(equalTo: self.dropView.centerXAnchor).isActive = true
                button.heightAnchor.constraint(equalToConstant: 40).isActive = true
                
                button.dropView.dropDownOptions = ["Itau","Santander","C6","Nubank","Safra","Banco do Brasil"]
     ...
     var height = NSLayoutConstraint()
        ...
        override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
            ...
            if isOpen == false{
                ...
                if self.dropView.tableView.contentSize.height > 75{
    ...
    class dropDownView: UIView, UITableViewDelegate, UITableViewDataSource {
        ...
        override init(frame: CGRect) {
            ...
            //self.backgroundColor = UIColor(red: 0.2, green: 0.2, blue: 0.4, alpha: 1)
